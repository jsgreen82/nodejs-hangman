...
var checkForLetter = require('./words.js');
...
var game = {
  ...
  startGame : function(){
    ...
    console.log('Guess the 20th Century Artist');
...
function keepPromptingUser(){
  ...
  if(game.guessesRemaining > 0){
    inquirer.prompt([
      ...
      if(alphabet.indexOf(inputLetter) == -1){
        ...
        console.log('Guess again, "' + inputLetter + '" is not a letter.');
        console.log('Guesses Left: ' + game.guessesRemaining);
  ...
  // If not enough guesses left, then user losses
    ...
    console.log('The artist was "' + game.currentWrd + '".');
  }
